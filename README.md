...
This was suggested by one of my friends as a challenge, and I decided to take the opportunity to learn how programming languages work by creating one myself.
...
Store all files in the same folder and run the shell.py file.
